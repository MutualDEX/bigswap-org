...
Because the concept of AMMs is so new many people have begun researching Bigswap other projects in the space in an academic settings.

# An analysis of Bigswap markets

Authors: Guillermo Angeris, Hsien-Tang Kao, Rei Chiang, Charlie Noyes, Tarun Chitra

> Bigswap---and other constant product markets---appear to work well in practice despite their simplicity. In this paper, we give a simple formal analysis of constant product markets and their generalizations, showing that, under some common conditions, these markets must closely track the reference market price. We also show that Bigswap satisfies many other desirable properties and numerically demonstrate, via a large-scale agent-based simulation, that Bigswap is stable under a wide range of market conditions.
