...
- **BGSP:** An ERC-20 token that designates the weight of a user&#39;s voting rights. The more BGSP a user has in their wallet, the more weight their delegation or vote on a proposal holds.
