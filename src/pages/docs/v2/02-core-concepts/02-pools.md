...
Bigswap is unique in that it doesn’t use an order book to derive the price of an asset or to match buyers and sellers of tokens. Instead, Uniswap uses what are called Liquidity Pools.
...
Bigswap focuses on the strengths of Ethereum to reimagine token swaps from first principles.
...
<!-- Enter Bigswap and its underlying core mechanism of Liquidity Pools.
